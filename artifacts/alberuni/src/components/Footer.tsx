    ...
    <footer className="bg-primary text-primary-foreground py-12">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="size-10 rounded-xl bg-white flex items-center justify-center text-primary font-bold text-xs">
                OIM
              </div>
              <div>
                <p className="font-bold text-base leading-tight">Olmazor ixtisoslashtirilgan maktabi</p>
                <p className="text-primary-foreground/70 text-xs">Toshkent shahri</p>
              </div>
            </div>
            <p className="text-primary-foreground/80 text-sm">
              Bilimli, ijodkor va vatanparvar avlodni tarbiyalash — bizning asosiy maqsadimiz.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              <li><Link href="/#about" className="hover:text-white transition-colors">Maktab haqida</Link></li>
              <li><Link href="/#education" className="hover:text-white transition-colors">Ta'lim</Link></li>
              <li><Link href="/news" className="hover:text-white transition-colors">Yangiliklar</Link></li>
              <li><Link href="/contact" className="hover:text-white transition-colors">Bog'lanish</Link></li>
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8 text-center text-sm text-primary-foreground/60">
          <p>&copy; {new Date().getFullYear()} Olmazor ixtisoslashtirilgan maktabi. Barcha huquqlar himoyalangan.</p>
        </div>
      </div>
    </footer>
  );
