...
export const UpdateStatisticsBody = zod.object({
  "students": zod.int().optional(),
  "professors": zod.int().optional(),
  "departments": zod.int().optional(),
  "years": zod.int().optional(),
  "programs": zod.int().optional(),
  "partners": zod.int().optional()
})
...
export const CreateAlumniResponse = zod.object({
  "id": zod.int(),
  "name": zod.string(),
  "nameRu": zod.string().nullish(),
  "graduationYear": zod.int(),
...
export const UpdateAlumniBody = zod.object({
  "name": zod.string().optional(),
  "nameRu": zod.string().optional(),
  "graduationYear": zod.int().optional(),
...
export const DeleteAlumniResponse = zod.void()
...
export const DeleteClassroomResponse = zod.void()
...
export const GetAdminDashboardResponse = zod.object({
  "totalNews": zod.int(),
  "totalBanners": zod.int(),
  "totalGalleryImages": zod.int(),
